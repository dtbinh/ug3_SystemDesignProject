 ...
 * method must be called on the associated {@link VideoDevice}. YVU frame grabbers
...
public class YVUFrameGrabber extends AbstractGrabber {
	 ...
	 * uses, ie the one images are retrieved from the device BEFORE YVU 
	 * conversion.
	...
	protected void createBuffers(int bufferSize) {
		...
		while(numberOfBuffers-- > 0)
			...
			// and BufferedImage for planar YVU420 image format
